          ...
          <Box>
            ...
            <Box pt={2}>
              ...
              >
                ...
                {activeStep === steps.length - 1 ? <Button sx={{ ml: 2 }} variant="contained" color="primary" onClick={handleSubmit}>Enregister</Button> : <Button sx={{ ml: 2 }} variant="contained" color="primary" onClick={handleNext}>Suivant</Button>}
