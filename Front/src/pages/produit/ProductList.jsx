...
const ProduitsList = () => {
  ...
  const renderStatus = (status) => {
    ...
    if (status === "Desactivé")
      return <StyledSpan bgColor={bgError}>{status}</StyledSpan>;
  };
      ...
      <div className="m-5 mt-3 mb-3">
        ...
        <div className=" text-start mb-3">
          <button className="btn btn-primary " onClick={openModal}>
            {" "}
            <AddCircleIcon /> Nouveau Produit{" "}
          </button>
          <NewProduits
            isOpen={isOpen}
            onClose={closeModal}
            chargerListProduct={chargerListProduct}
          />
        </div>
                  ...
                  .map((List) => (
                    <TableRow key={List.id_produit}>
                      ...
                      <TableCell align="center">
                        ...
                        <IconButton
                          onClick={() => handleDeleteProduct(List.id_produit)}
                        >
